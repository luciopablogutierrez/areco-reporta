      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Reportes totales en el sistema.</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Porcentaje de reportes resueltos.</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Tiempo de Respuesta Prom.</CardTitle>
            <Clock className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">1.2 días</div>
            <p className="text-xs text-muted-foreground">Valor de ejemplo.</p>
          </CardContent>
        </Card>
      </div>
